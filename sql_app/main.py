...
#delete
@app.delete("/bookings/{booking_id}",response_model=None)
async def delete_booking(booking_id: int, db: Session = Depends(get_db)):
    already_booked = crud.get_booking(db, booking_id = booking_id)
    return crud.delete_booking(db, already_booked)
